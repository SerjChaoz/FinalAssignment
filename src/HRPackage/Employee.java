 ...
 */
     ...
     * for creating a employee object has not been hired. 
     * reference;
     * @param firstName
     * @param lastName
     * @param address
            ...
            int yearBirth, int monthBirth, int dayBirth)
    {
        ...
        this._empId = ServiceClass.getEmployeeID();
    }
    ...
    /**
     *  place holder method for simple information
     * of the employee type in a simplified fashion; 
     * Have not used in however in any scope yet.
    ...
    /** 
     * returns the first name, last name, and the date of hire of the 
     * employee
     * @return 
     */
    @Override
